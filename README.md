# 低卡路里食记
低卡路里食记是一款必不可少的减肥健康类APP。想减肥？拍照即可记录卡路里！

健身，三分练，七分吃;
保证你卡路里消耗大于卡路里摄入量，才是减肥成功的关键！
低卡路里食记，可以帮助你记录每日的饮食热量摄入。

我们的特色：
拍照识别：打开应用选择拍照，即可马上拍照识别食物热量，让你理性减肥！
相册图片识别：打开应用选择相册内的美食照片，即可马上得知卡路里热量！
热量记录：记录你的每日摄入并计算bmr
控卡计划：参与控卡计划并完成挑战即可获得称号
